...
public class GamblingMachineTestSuite {
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/gamblingDataSource.csv")
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/gamblingDataSource1.csv")
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/gamblingDataSource2.csv")
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/gamblingDataSource3.csv")
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/gamblingDataSource4.csv")
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/gamblingDataSource5.csv")
